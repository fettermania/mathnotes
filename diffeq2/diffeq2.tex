...
\item Set $q = x+iw, dq = dx$ and with the identity in hand, the integral becomes $\frac{u_0}{(2\pi)^3}e^{-\frac{1}{2}\|\vec{\omega}\|^2} \int e^{-\frac{1}{2}q^2} dq =\frac{u_0}{(2\pi)^{\frac{3}{2}}} e^{-\frac{1}{2}\|\vec{\omega}\|^2} $
\end{itemize}
