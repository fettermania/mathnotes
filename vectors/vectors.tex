...
\item NOTE: They then mention the Jacobian $J = |  \det\begin{pmatrix} \frac{\delta x}{\delta u} & \frac{\delta x}{\delta v} \\ \frac{\delta y}{\delta u} & \frac{\delta y}{\delta v}  \end{pmatrix}  | = 1$
