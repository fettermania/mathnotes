...
However, if $g$ is of the special form $g=p^k+1, p \in \mathbb{P}, k \in \mathbb{N}$, we can construct a deck, and beyond that, we can prove the following four constructions are surprisingly equivalent\footnote{or, at least, one can derive any from the other}:
\\
\begin{enumerate}
